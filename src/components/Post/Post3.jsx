...
function Post3() {
    return (
        ...
        <div className='post'>
             <img className='postImg' src='https://www.nust.na/sites/default/files/news/HTTPS-hosts.jpg' alt='Future'/>
        <div className="postInfo">
          <div className="postIntros">
          <span className='postIntro'>VIRTUAL REALITY |</span>
          <span className='postIntro'>AUGMENTED REALITY</span>
          </div>
    
          <span className='postTitle'> VIRTUAL TECHNOLOGIES</span>
          <hr/>
